        ...
        if prefix == 'bplist' or prefix == '<?xml ':
            if prefix == 'bplist':
                ...
                if not sys.version_info >= (3, 4):
                    import Foundation
                    plistNSData, errorMessage = Foundation.NSData.dataWithContentsOfFile_options_error_(self.file_path, Foundation.NSUncachedRead, None);
                    if errorMessage == None:
                        ...
                        if errorMessage == None:
                            ...
                            message = '[plist_helper]: %s' % errorMessage
